...
import org.neo4j.driver.internal.shaded.io.netty.handler.ssl.ApplicationProtocolConfig.SelectorFailureBehavior;
...
final class Target_org_neo4j_driver_internal_shaded_io_netty_util_internal_CleanerJava6 {
...
final class Target_org_neo4j_driver_internal_shaded_io_netty_util_internal_PlatformDependent0 {
...
final class Target_org_neo4j_driver_internal_shaded_io_netty_util_internal_shaded_org_jctools_util_UnsafeRefArrayAccess {
...
@Delete
@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.ReferenceCountedOpenSslEngine")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_ReferenceCountedOpenSslEngine {
}

@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.JdkSslServerContext")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslServerContext {

    @Alias
    Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslServerContext(Provider provider,
...
@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.JdkSslClientContext")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslClientContext {

    @Alias
    Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslClientContext(Provider sslContextProvider,
            X509Certificate[] trustCertCollection,
            TrustManagerFactory trustManagerFactory, X509Certificate[] keyCertChain, PrivateKey key,
            String keyPassword, KeyManagerFactory keyManagerFactory, Iterable<String> ciphers,
...
@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.SslHandler$SslEngineType")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_SslHandler$SslEngineType {

    @Alias
    public static Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_SslHandler$SslEngineType JDK;

    @Substitute
    static Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_SslHandler$SslEngineType forEngine(SSLEngine engine) {
        return JDK;
    }
}

@Delete
@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.ConscryptAlpnSslEngine")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_ConscryptAlpnSslEngine {
}

@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.SslContext")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_SslContext {
    ...
    static SslContext newServerContextInternal(SslProvider provider, Provider sslContextProvider,
        ...
        return (SslContext) (Object) new Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslServerContext(
                sslContextProvider,
                trustCertCollection,
    ...
    static SslContext newClientContextInternal(SslProvider provider, Provider sslContextProvider, X509Certificate[] trustCert,
        ...
        return (SslContext) (Object) new Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslClientContext(
                sslContextProvider, trustCert,
                trustManagerFactory,
...
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkDefaultApplicationProtocolNegotiator {

    @Alias
    public static Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkDefaultApplicationProtocolNegotiator INSTANCE;
}

@TargetClass(className = "org.neo4j.driver.internal.shaded.io.netty.handler.ssl.JdkSslContext")
final class Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkSslContext {

    @Substitute
    static JdkApplicationProtocolNegotiator toNegotiator(ApplicationProtocolConfig config, boolean isServer) {
        if (config == null) {
            return (JdkApplicationProtocolNegotiator) (Object) Target_org_neo4j_driver_internal_shaded_io_netty_handler_ssl_JdkDefaultApplicationProtocolNegotiator.INSTANCE;
        }
...
final class Target_org_neo4j_driver_internal_shaded_io_netty_bootstrap_AbstractBootstrap {
